...
$K$ clusters. $K$-means is referred to as an unsupervised learning algorithm. 
That is, an exploratory data analytic technique where we are trying to learn as 
much as possible about the data without the aid of training data or labels as is
using the case in a regression or classification model (supervised learning). The 
